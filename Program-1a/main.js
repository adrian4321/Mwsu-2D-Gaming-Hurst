var mainState = {
    ...
    preload: function() {
        game.load.image('player', 'assets/small_rasta.png');
        game.load.image('wallV', 'assets/wallVertical.png');
        game.load.image('wallH', 'assets/wallHorizontal.png');
        game.load.image('coin', 'assets/small_weed.png');
        game.load.image('enemy', 'assets/small_babylon.png');
		game.load.image('background1', 'assets/rasta_background.png');
    },
    ...
    update: function() {
		...
		// Game Clock
		// Math.round to turn into integer 
		this.time -= 1;
